...
public class TripDtos {
    public record TripCreateRequest(@NotNull Long routeId, @NotNull Long busId, @NotNull LocalDate localDate,@NotNull OffsetDateTime departureTime,@NotNull OffsetDateTime arrivalTime) implements java.io.Serializable {}
