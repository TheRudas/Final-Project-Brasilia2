...
public class TripDtos {
    public record TripCreateRequest(@NotNull Long routeId, @NotNull Long busId, @NotNull LocalDate localDate,@NotBlank OffsetDateTime departureTime,@NotBlank OffsetDateTime arrivalTime) implements java.io.Serializable {}
